...
5. [04 Regions, terrain, weather, and population](04_world_simulation_foundations.md)
6. [05 Organizations and settlement foundations](05_organizations_and_settlements.md)
7. [06 Construction, roads, housing, economy, production, and trade](06_settlement_economy.md)
8. [07 NPC identity, schedules, and occupations](07_npc_identity_schedules_occupations.md)
9. [08 Cognitive records and sleep consolidation](08_npc_cognition_records_and_consolidation.md)
10. [08a NPC knowledge](08a_npc_knowledge.md)
11. [09 Retrieval, context assembly, and boundary enforcement](09_npc_retrieval_context_boundary.md)
12. [09a Perception-boundary enforcement](09a_perception_boundary_enforcement.md)
13. [10 Local LLM cognition client](10_local_llm_cognition_client.md)
14. [11 NPC Cognition Protocol and action gateway](11_npc_cognition_protocol_action_gateway.md)
15. [12 NPC conversations](12_npc_conversations.md)
16. [13 Council meetings](13_council_meetings.md)
17. [14 v0.5 release closeout](14_v05_release_closeout.md)
